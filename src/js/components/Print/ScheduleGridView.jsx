...
var ScheduleGridView = React.createClass({
    ...
    */
    ...
    renderUniBreadcrumbs: function(data) {
        if (this.props.groupId) {
            return <li className="breadcrumb-item"><a href={`/faculty/${data.faculty.id}/groups/`}>{data.faculty.name}</a></li>
        }
    },
                ...
                <div className="row">
                    <div className="col-md-12">
                        <ol className="breadcrumb">
                            ...
                            {this.renderUniBreadcrumbs(data)}
